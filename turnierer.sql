...
--
-- Host: localhost
-- Generation Time: Jan 24, 2017 at 08:17 AM
...
CREATE TABLE `games` (
  ...
  `vs_team_id` int(11) NOT NULL,
  `team_result` int(11) DEFAULT NULL,
  `vs_team_result` int(11) DEFAULT NULL,
...
CREATE TABLE `tournaments` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `start_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `point_win` int(11) NOT NULL,
  `point_draw` int(11) NOT NULL,
  `point_lose` int(11) NOT NULL,
